 ...
 */
public class RegistrationActivtiy extends FragmentActivity  implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupTab(TAG_REGISTER, R.drawable.ic_tab_ic_tab_login, R.string.register, RegisterFragment.class);
